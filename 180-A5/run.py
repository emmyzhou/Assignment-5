...
def main(targets):
    ...
    if "test" in targets:
        ...
        parser.add_argument(
            "test",
            default=None,
            help="Test argument for testing purpose."
        )
        ...
        parser.add_argument(
            "--data_dir",
            default="../dataset/wikigold_distant",
            type=str,
            required=False,
            help="The input data dir. Should contain the training files for the CoNLL-2003 NER task.",
        )
    ...
    if args.do_train:
        ...
        global_step, tr_loss, best_dev, best_test = train(args, train_dataset, model, tokenizer, labels,
                                                          pad_token_label_id)
